...
func LoadRemoteFile(ctx context.Context, rawURL string, chatFileType model.ChatFileType) *model.File {
...
func BuildToolResponseParts(toolCallID, toolName, toolResult string, ok bool, l *log.Entry) (openai.ChatCompletionMessage, []openai.ChatMessagePart) {
